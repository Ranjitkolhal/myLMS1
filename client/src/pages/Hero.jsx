  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: [
        ...
        "Where learning becomes an adventure, Standard Security Solutions leads the way.",
        "Unlock the secrets of the universe with Standard Security Solutions. ",
        "Unleash the power of knowledge with Standard Security Solutions.",
        "Experience the joy of discovery with Standard Security Solutions.",
        "Standard Security Solutions: Empowering minds to reach new heights.",
        "Standard Security Solutions: Where ideas come to life and minds thrive.",
        "Standard Security Solutions: Nurturing minds to create a brighter tomorrow.",
        "Standard Security Solutions: Unlocking the potential of every mind.",
        "Enlighten your mind with Standard Security Solutions's limitless knowledge.",
        "Explore the wonders of the world with Standard Security Solutions."
      ],
      typeSpeed: 70,
      backDelay: 700,
      smartBackspace: true,
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <div className="-m-1.5 p-1.5 ">
              <span className="sr-only">Standard Security Solutions</span>
              {/* <img
        ...
        <div className="mx-auto max-w-2xl py-6 pt-6 sm:pt-24 lg:pt-28">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-md leading-6 text-gray-600 ring-1 ring-gray-900/30 hover:ring-gray-900/30">
              Teach, inspire, and grow with us dynamic learning platform. {' '}
