			...
			<div className="flex nexa-font flex-col md:flex-row">
				...
				<div className="md:w-3/5 mx-3">
					...
					<div className='p-5 mt-5'>
						...
						<div className='ml-5 flex justify-between viewMob'>
							<div>
								<h3 className='text-3xl '>{course.title}</h3>
								<h3 className='text-md text-gray-500 text-center'>{course.tagline}</h3>
							</div>
							<br />
							<div className='flex flex-col justify-center'>
								<h3 className='text-xs text-gray-500 text-end'>{fomattedDate?.createdAt}</h3>
						...
						<div className="flex justify-center pb-4">
							<video controlsList="nodownload" className="w-full rounded-lg" controls src={lesson.videoURL} type="video/mp4">
							</video>
						</div>

						<div className='ml-3 flex justify-between viewSmall'>
						...
						<div className='text-justify'>
							<h1 className='text pb-4'>About : </h1>
							<span className='text-justify ml-2'>{course.about}</span>
						</div>
				...
				<div className="md:w-2/5 mx-3 mt-3 md:mt-20 md:mr-10 viewLast">
