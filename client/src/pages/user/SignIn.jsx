...
function SignIn() {
  ...
  const handleSignInSuccess = (user) => {
    ...
    toast.success(`Hey ${user.name}, Welcome back to LMS!`, {
      duration: 6000
    })
    ...
    <>
      ...
      <div className="flex nexa-font min-h-full flex-1 flex-col justify-center px-6 lg:px-8 h-screen ">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <img
            className="mx-auto h-10 w-auto ownCompanyLogo"
            src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
            alt="Your Company"
          />
          <div className='flex justify-center'>
            {/* <Logo className="notMobile" size={1} /> */}
          </div>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="#" method="POST">
            ...
            <div className='flex notMobFlex justify-center'>
              {/* Google sign in */}
