  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <div className="flex nexa-font namu">
          {/* Left Course details section  */}
          <div className="w-3/5 mx-3 thisCourse">
            <SectionTitle
            ...
            {/* left section 1 */}
            <div className="flex justify-around px-20 mt-10 bg-white rounded-xl p-10 thisTour">
              <div className="flex justify-center items-center  thisTour">
                <img
                  className="rounded-full h-20 w-20"
                  src="https://raw.githubusercontent.com/iskconpandharpur/LSM/main/Unknown-removebg-preview%20(1).png"
                  alt="profile picture"
                />
              ...
              <div className="flex flex-row-reverse justify-center items-center ">
                <div className="text-xl text-center px-4 text-gray-400 cate">
                  Category
                  <hr />
            ...
            <div className="bg-white flex p-3 my-3 rounded-lg">
              <ul className="flex justify-evenly w-full">
                ...
                <li className="flex gap-2">
                  ...
                  {course?.totalStudentsEnrolled ?? 15} enrolled
                </li>
              </ul>
            </div>

            {/* left section 3 */}
            <div className="flex justify-center bg-white rounded-xl mt-2 thisPayment">
              <div
                      ...
                      <ul>
                        <li>
                          <div className="p-5">
                            ...
                            <div className="ml-5 flex justify-between addMob">
                              <div>
                              ...
                              <div className="flex flex-col justify-center text-end">
                                <h3 className="text-xs text-gray-500">
                                  {fomattedDate?.createdAt}
                                </h3>
                                <h3 className="text-xs text-gray-500 text-end">
                                  {fomattedDate?.timeAgo} ago
                                </h3>
                              </div>
                            </div>
                            <HorizontalRule />
          ...
          <div className="w-2/5 mx-3 thisPayment">
                    ...
                    <>
                      ...
                      <Modal
                        ...
                        modalData={{
                          ...
                          description:
                            'By clicking "Confirm" you are accepting theora payment procedures and proceed to payment',
